...
{
    public const PENGING_STATE = 'PS_OS_ECOMMPAY_PENDING';
    ...
    private const TEMPATE_PAYMENT = 'payment';
    private const TEMPATE_PAYMENT_ERROR = 'payment_error';
    private const TEMPATE_REFUND = 'refund';
    ...
    {
        if (Configuration::get(self::PENGING_STATE) > 0) {
            return;
        }
        ...
        Configuration::updateValue(self::PENGING_STATE, $OrderState->id);
    ...
    private function createApprovedState(): void
    {
        ...
        $OrderState->deleted = false;
        $OrderState->template = self::TEMPATE_PAYMENT;
        $OrderState->add();
    ...
    private function createDeclinedState(): void
    {
        ...
        $OrderState->paid = false;
        $OrderState->deleted = false;
        $OrderState->template = self::TEMPATE_PAYMENT_ERROR;
        $OrderState->add();
    ...
    private function createRefundedState(): void
    {
        ...
        $OrderState->paid = false;
        $OrderState->deleted = false;
        $OrderState->template = self::TEMPATE_REFUND;
        $OrderState->add();
